                ...
                <div className="cards__wrapper">
                    <ul className="cards__items ">
                        <CardItem
                            ...
                            text='split and share: Find a perfect flatmate, a perfect flat and calculate the fairly price for your room'
                        ...
                        <CardItem
                            src='images/wit.png'
                            text='Women in tech : To close the gender gap that exists in the tech industry, by helping women who work in the tech sector to network through events. the main goal is to motivate more women to build businesses or to choose a career in the digital industry
'
                            label='hbs, node.js'
